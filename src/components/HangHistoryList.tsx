...
export default class HangHistoryList extends React.Component<Props> {
  render() {
    const orderedHangs = this.props.friendHangs.sort((a:Hang,b:Hang) => (a.date > b.date) ? 1 : ((b.date > a.date) ? -1 : 0));
